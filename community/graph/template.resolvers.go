...
func (r *queryResolver) Templates(ctx context.Context, stages map[string]interface{}) (*model.Templates, error) {
	pipeline := bson.A{}
	...
	cursor, err := r.db.Collection("templates").Aggregate(ctx, pipeline)
	if err != nil {
		return nil, err
	}
