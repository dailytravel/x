...
func (r *queryResolver) Locales(ctx context.Context, stages map[string]interface{}) (*model.Locales, error) {
	pipeline := bson.A{}
	...
	cursor, err := r.db.Collection("locales").Aggregate(ctx, pipeline)
	if err != nil {
		return nil, err
	}
