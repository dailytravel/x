...
const gateway = new ApolloGateway({
  ...
  supergraphSdl: new IntrospectAndCompose({
    subgraphs: [
      ...
      { name: "insight", url: "http://localhost:4007/query" },
      { name: "marketing", url: "http://localhost:4008/query" },
      { name: "payment", url: "http://localhost:4009/query" },
      { name: "sales", url: "http://localhost:4010/query" },
      { name: "workspace", url: "http://localhost:4011/query" },
    ],
  }),
});
