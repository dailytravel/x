...
const gateway = new ApolloGateway({
  ...
  supergraphSdl: new IntrospectAndCompose({
    subgraphs: [
      ...
      { name: "community", url: "http://localhost:4003/query" },
      { name: "config", url: "http://localhost:4004/query" },
      { name: "finance", url: "http://localhost:4005/query" },
      { name: "hrm", url: "http://localhost:4006/query" },
      { name: "marketing", url: "http://localhost:4007/query" },
      { name: "payment", url: "http://localhost:4008/query" },
      { name: "reporting", url: "http://localhost:4009/query" },
      { name: "sales", url: "http://localhost:4010/query" },
      { name: "search", url: "http://localhost:4011/query" },
      { name: "workspace", url: "http://localhost:4012/query" },
    ],
  }),
});
