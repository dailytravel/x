...
func (r *companyResolver) Created(ctx context.Context, obj *model.Company) (*model.User, error) {
	var item *model.User
...
func (r *companyResolver) Updated(ctx context.Context, obj *model.Company) (*model.User, error) {
	var item *model.User
