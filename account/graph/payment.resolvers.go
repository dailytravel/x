...
func (r *paymentResolver) Created(ctx context.Context, obj *model.Payment) (*model.User, error) {
	var item *model.User
...
func (r *paymentResolver) Updated(ctx context.Context, obj *model.Payment) (*model.User, error) {
	var item *model.User
