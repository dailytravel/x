...
func (r *contactResolver) Created(ctx context.Context, obj *model.Contact) (*model.User, error) {
	var item *model.User
...
func (r *contactResolver) Updated(ctx context.Context, obj *model.Contact) (*model.User, error) {
	var item *model.User
