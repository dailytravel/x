...
func (r *campaignResolver) Created(ctx context.Context, obj *model.Campaign) (*model.User, error) {
	var item *model.User
...
func (r *campaignResolver) Updated(ctx context.Context, obj *model.Campaign) (*model.User, error) {
