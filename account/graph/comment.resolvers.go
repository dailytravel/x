...
func (r *commentResolver) Created(ctx context.Context, obj *model.Comment) (*model.User, error) {
	var item *model.User
...
func (r *commentResolver) Updated(ctx context.Context, obj *model.Comment) (*model.User, error) {
	var item *model.User
