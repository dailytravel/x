...
func (r *reactionResolver) Created(ctx context.Context, obj *model.Reaction) (*model.User, error) {
	var item *model.User
...
func (r *reactionResolver) Updated(ctx context.Context, obj *model.Reaction) (*model.User, error) {
	var item *model.User
