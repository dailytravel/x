...
func (r *contentResolver) User(ctx context.Context, obj *model.Content) (*model.User, error) {
	var item *model.User
...
func (r *contentResolver) Created(ctx context.Context, obj *model.Content) (*model.User, error) {
	var item *model.User
...
func (r *contentResolver) Updated(ctx context.Context, obj *model.Content) (*model.User, error) {
	var item *model.User
