...
func (r *expenseResolver) Created(ctx context.Context, obj *model.Expense) (*model.User, error) {
	var item *model.User
...
func (r *expenseResolver) Updated(ctx context.Context, obj *model.Expense) (*model.User, error) {
	var item *model.User
