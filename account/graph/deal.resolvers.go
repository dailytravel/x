...
func (r *dealResolver) Created(ctx context.Context, obj *model.Deal) (*model.User, error) {
	var item *model.User
...
func (r *dealResolver) Updated(ctx context.Context, obj *model.Deal) (*model.User, error) {
	var item *model.User
