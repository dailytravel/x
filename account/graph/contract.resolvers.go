...
func (r *contractResolver) Created(ctx context.Context, obj *model.Contract) (*model.User, error) {
	var item *model.User
...
func (r *contractResolver) Updated(ctx context.Context, obj *model.Contract) (*model.User, error) {
	var item *model.User
