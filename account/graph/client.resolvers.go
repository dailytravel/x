...
func (r *queryResolver) Clients(ctx context.Context, stages map[string]interface{}) (*model.Clients, error) {
	pipeline := bson.A{}
	...
	cursor, err := r.db.Collection("clients").Aggregate(ctx, pipeline)
	if err != nil {
		return nil, err
	}
