...
func (r *goalResolver) User(ctx context.Context, obj *model.Goal) (*model.User, error) {
	var item *model.User
...
func (r *goalResolver) Created(ctx context.Context, obj *model.Goal) (*model.User, error) {
	var item *model.User
...
func (r *goalResolver) Updated(ctx context.Context, obj *model.Goal) (*model.User, error) {
	var item *model.User
