...
func (r *listResolver) User(ctx context.Context, obj *model.List) (*model.User, error) {
	var item *model.User
...
func (r *listResolver) Created(ctx context.Context, obj *model.List) (*model.User, error) {
	var item *model.User
...
func (r *listResolver) Updated(ctx context.Context, obj *model.List) (*model.User, error) {
	var item *model.User
