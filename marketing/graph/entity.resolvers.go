...
// FindLinkByID is the resolver for the findLinkByID field.
func (r *entityResolver) FindLinkByID(ctx context.Context, id string) (*model.Link, error) {
	panic(fmt.Errorf("not implemented: FindLinkByID - findLinkByID"))
}
