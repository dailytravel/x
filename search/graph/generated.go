...
type ComplexityRoot struct {
	Mutation struct {
		Index func(childComplexity int, args map[string]interface{}) int
	}
...
type MutationResolver interface {
	Index(ctx context.Context, args map[string]interface{}) (map[string]interface{}, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.index":
		...
		args, err := ec.field_Mutation_index_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.Index(childComplexity, args["args"].(map[string]interface{})), true
...
//go:embed "schema.graphqls" "schema/search.graphql"
...
func (ec *executionContext) field_Mutation_index_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
...
func (ec *executionContext) _Mutation_index(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Index(rctx, fc.Args["args"].(map[string]interface{}))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
