...
func (r *queryResolver) Transactions(ctx context.Context, filter map[string]interface{}, project map[string]interface{}, sort map[string]interface{}, collation map[string]interface{}, limit *int, skip *int) (*model.Transactions, error) {
	...
	cursor, err := r.db.Collection("transactions").Find(ctx, _filter, opts)
	if err != nil {
		return nil, err
	}
	...
	//get total count
	count, err := r.db.Collection("transactions").CountDocuments(ctx, _filter, nil)
	if err != nil {
		return nil, err
	}
